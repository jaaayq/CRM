...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-1000 dark:bg-gray-1000 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="brand_logo_container pl-24">
                    <img src="{{asset('dist/img/dostlogo.png')}}" class="brand_logo" alt="Logo" style="width:75px;">
                </div>


                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                  
                        <div class="p-6 bg-gray-1100">

                            <div class="text-center items-center">
                               
                                <div class="ml-4 text-lg leading-7 font-semibold">  <a href="#" class="text-gray-900 dark:text-white"></a></div>
                                    ...
                                    <div class="form text-gray-200 text-center">
                                        ...
                                        <form action="{{ route('customercode') }}" method="POST">
                                            ...
                                            <input class="w-full rounded-lg px-2 py-1 text-center font-RO" type="text" name="code" placeholder="i.e 12345" required > <br>
